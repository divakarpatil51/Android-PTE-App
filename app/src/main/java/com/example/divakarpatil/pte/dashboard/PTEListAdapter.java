...
public class PTEListAdapter extends BaseExpandableListAdapter {
    ...
    void setInflater(LayoutInflater inflater, Activity activity) {
     ...
     *                      guaranteed that the convertView will have been previously
     *                      created by
     * @param parent        the parent that tsshis view will eventually be attached to
